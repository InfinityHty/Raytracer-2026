...
fn main() {
    ...
    let ground = Rc::new(Lambertian {
        texture: Rc::new(SolidColor::new(Vec3::new(0.48, 0.83, 0.53))),
    });
    let box_per_side = 20;
    ...
    world.add(Rc::new(BvhNode::new(&mut box1.objects, 0, box1_size)));
    //
    ...
    let sphere_material = Rc::new(Lambertian {
        texture: Rc::new(SolidColor::new(Vec3::new(0.7, 0.3, 0.1))),
    });
    let sphere = Rc::new(MovingSphere::new(
    ...
    let glass_sphere = Rc::new(Sphere::new(
    ...
    let metal_sphere = Rc::new(Sphere::new(
    ...
    let smoke = Rc::new(ConstantMedium::new(
        boundary,
        0.2,
        Rc::new(Isotropic::new(Rc::new(SolidColor::new(Vec3::new(
            0.2, 0.4, 0.9,
        ))))),
    ));
    world.add(smoke);
    ...
    let atmosphere = Rc::new(ConstantMedium::new(
        boundary,
        0.0001,
        Rc::new(Isotropic::new(Rc::new(SolidColor::new(Vec3::new(
            1.0, 1.0, 1.0,
    ...
    let img = ImageReader::open(img_path)
        ...
        .decode()
        .expect("图片解码失败");
    let earth_material = Rc::new(Lambertian {
        texture: Rc::new(ImageTexture::new(img)),
    });
    ...
    let noise_sphere = Rc::new(Sphere::new(
    ...
    world.add(Rc::new(Translate::new(
        Rc::new(RotateY::new(
            Rc::new(BvhNode::new(&mut box2.objects, 0, box2_size)),
            15.0,
        )),
